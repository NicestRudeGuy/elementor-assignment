...
/**
 * Main Elementor Assignment Class
 *
 * The init class that runs the Elementor Assignment plugin.
 ...
 */
final class Elementor_Assignment {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-assignment' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_ASSIGNMENT ) );
...
// Instantiate Elementor_Assignment.
new Elementor_Assignment();
